...
Namespace EGVControls
    <ToolboxData("<{0}:EGVButton runat=server></{0}:EGVButton>")>
    Public Class EGVButton
        Inherits Button
...
#Region "Public Properties"
        ...
        Public Property Size As EGV.Enums.ButtonSizes = EGV.Enums.ButtonSizes.Normal
        Public Property Color As EGV.Enums.ControlColors = EGV.Enums.ControlColors.Default
        Public Property ValidationTargets As String = String.Empty
...
#Region "Overridden Methods"
        ...
        Protected Overrides Sub AddAttributesToRender(writer As HtmlTextWriter)
            ...
            If ValidationTargets <> String.Empty Then writer.AddAttribute("data-valtarget", ValidationTargets)
        End Sub
